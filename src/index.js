...
if (DEBUG_INPUT) {
    console.warn('ENV: debug input = ' + DEBUG_INPUT);
...
if (API_SERVER_WEBSOCKET_URL != null) {
    console.warn('ENV: overriding the API websocket server to be: ' + API_SERVER_WEBSOCKET_URL);
    apiServerWebsocket = API_SERVER_WEBSOCKET_URL;
}
